...
class MissionCategoryAnalysisControllerTest {
    ...
    void returnsCamelCaseResponse() throws Exception {
        ...
        mockMvc.perform(get("/api/missions/categoryAnalysis"))
                ...
                .andExpect(jsonPath("$.data.cumulativeTransactionCount").value(72))
                .andExpect(jsonPath("$.data.requiredCumulativeTransactionCount").value(50))
                .andExpect(jsonPath("$.data.relativeEligible").doesNotExist())
