...
export const MOCK_TODO_ITEMS = [
    { id: 1, type: 'accuse', title: '기소 되어 변론이 필요해요!', amount: 6800, challengeName: '배달 소비 줄이기', deadlineMinutes: 26 * 60 },
    ...
    { id: 4, type: 'accuse', title: '기소 되어 변론이 필요해요!', amount: 23000, challengeName: '신상 지름신 봉인령', deadlineMinutes: 44 * 60 },
